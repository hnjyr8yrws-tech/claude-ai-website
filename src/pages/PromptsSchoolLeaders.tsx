  ...
  <>
    ...
    <section className="px-5 sm:px-8 py-8 border-t" style={{ background: 'white', borderColor: '#e8e6e0' }}>
      <div className="max-w-3xl mx-auto flex flex-wrap gap-3">
        ...
        <Link to="/ai-training/leaders" className="text-sm font-medium px-4 py-2 rounded-lg border transition-colors hover:border-[var(--color-promptly-lime)] hover:text-[var(--color-promptly-lime)]" style={{ borderColor: '#e8e6e0', color: '#6b6760' }}>AI Training for Leaders →</Link>
