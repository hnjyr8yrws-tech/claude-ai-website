          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {pathwayItems.map((item, index) => (
              ...
              >
                ...
                <p className="text-sm flex-1 mb-4" style={{ color: '#4A4A4A' }}>{item.notes}</p>
                ...
                >
                  <div className="px-5 pt-5 pb-4 flex-1">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <span className="text-[10px] font-semibold uppercase tracking-wide" style={{ color: '#9C9690' }}>{item.category}</span>
                      <span
                        className="text-[10px] font-bold px-2 py-0.5 rounded-full"
                        style={item.type === 'Free' ? { background: '#f0fdf4', color: '#15803d' } : { background: '#fffbeb', color: '#92400e' }}
                      >
