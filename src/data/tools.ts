...
export const CAT_COLOURS: Record<string, { bg: string; text: string }> = {
  'Teacher AI': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Student AI': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'SEND': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Writing': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'General AI': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Creative': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Systems': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Parents': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Assessment': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Coding': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Research': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Productivity': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Wellbeing': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'MIS & Analytics': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'Safeguarding': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
  'AI Policy': { bg: 'var(--color-oat)', text: 'var(--color-ink)' },
...
export const TOOLS_RAW: ToolRaw[] = [
  // ── Teacher AI (24) ───────────────────────────────────────────────────────
  { name:"Brisk Teaching", category:"Teacher AI", subcategory:"Planning & Feedback", audience:["Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI lesson planning, feedback generation and rubric creation built for teachers.", url:"https://www.briskteaching.com", free:true },
  ...
  { name:"Curipod", category:"Teacher AI", subcategory:"Engagement", audience:["Teachers","Students"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"Create interactive AI lessons with polls, word clouds and open questions.", url:"https://curipod.com", free:true },
  ...
  { name:"Tes AI Tools", category:"Teacher AI", subcategory:"UK Resources", audience:["Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI resource creation from the UK's largest teacher community platform.", url:"https://www.tes.com/teaching-resources", free:true },
  { name:"Numerade", category:"Teacher AI", subcategory:"STEM", audience:["Teachers","Students"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI STEM video lessons and step-by-step problem solving for maths and science.", url:"https://www.numerade.com", free:true },
  ...
  { name:"Schoolytics", category:"Teacher AI", subcategory:"Analytics", audience:["Teachers","SLT"], ukReady:"Partial", safety:8, tier:"Trusted", desc:"AI student data analytics dashboard for Google Classroom teachers.", url:"https://schoolytics.com", free:true },
  ...
  { name:"Quizlet", category:"Student AI", subcategory:"Revision", audience:["Students","Parents"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI flashcard and study set platform with personalised revision sessions.", url:"https://quizlet.com", free:true },
  ...
  { name:"Sparx Reader", category:"Student AI", subcategory:"Reading", audience:["Students","Schools"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI reading platform that builds comprehension and vocabulary through personalised books.", url:"https://sparxreader.com", free:false },
  { name:"Seneca Learning", category:"Student AI", subcategory:"Revision", audience:["Students"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Free AI GCSE and A-Level revision platform with spaced repetition technology.", url:"https://senecalearning.com", free:true },
  ...
  { name:"Dragon Anywhere", category:"SEND", subcategory:"Speech to Text", audience:["Students","Teachers"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"Professional dictation app converting speech to text with high accuracy for SEND learners.", url:"https://www.nuance.com/en-gb/dragon/dragon-for-pc/dragon-home.html", free:false },
  ...
  { name:"Envision AI", category:"SEND", subcategory:"Visual Impairment", audience:["Students","Parents"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI glasses app that reads text, recognises faces and describes scenes for blind users.", url:"https://www.letsenvision.com", free:true },
  ...
  { name:"Adobe Express", category:"Creative", subcategory:"Design", audience:["Teachers","Students"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Free AI design tool for educators with templates for every classroom need.", url:"https://www.adobe.com/express/", free:true },
  ...
  { name:"Beautiful.ai", category:"Creative", subcategory:"Presentations", audience:["Teachers","SLT"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI smart presentation tool that auto-designs slides as you add content.", url:"https://www.beautiful.ai", free:false },
  ...
  { name:"Microsoft Copilot for Education", category:"Systems", subcategory:"AI Layer", audience:["Teachers","Students","Admin","SLT"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI layer across Microsoft 365 for Education — lesson planning, feedback and admin automation.", url:"https://www.microsoft.com/en-us/education", free:false },
  ...
  { name:"Arbor MIS", category:"Systems", subcategory:"UK MIS", audience:["Admin","SLT","Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Cloud-based management information system for UK schools with AI data insights.", url:"https://arbor-education.com", free:false },
  ...
  { name:"Smoothwall Monitor", category:"Systems", subcategory:"Filtering & Monitoring", audience:["Admin","SLT"], ukReady:"Yes", safety:10, tier:"Trusted", desc:"AI internet filtering and safeguarding monitoring solution for UK schools.", url:"https://www.smoothwall.com/education/", free:false },
  ...
  { name:"Lingokids", category:"Parents", subcategory:"Language", audience:["Parents","Students"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI English language learning app for young children aged 2–10.", url:"https://lingokids.com", free:true },
  ...
  { name:"micro:bit with AI", category:"Coding", subcategory:"Physical Computing", audience:["Students","Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"UK-backed physical computing device with AI and machine learning projects for schools.", url:"https://microbit.org", free:true },
  ...
  { name:"Lego Education SPIKE", category:"Coding", subcategory:"Robotics", audience:["Students","Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Hands-on STEM learning system combining Lego building with coding and robotics.", url:"https://education.lego.com/en-gb/45678/", free:false },
  ...
  // ── Wellbeing (2) ─────────────────────────────────────────────────────────
  { name:"Woebot", category:"Wellbeing", subcategory:"Mental Health AI", audience:["Students"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI mental health chatbot using CBT techniques to support emotional wellbeing.", url:"https://woebothealth.com", free:true },
  ...
  // ── SEND — additional (2) ─────────────────────────────────────────────────
  { name:"Therapy Box", category:"SEND", subcategory:"AAC & SLT", audience:["Students","SENCO","Parents"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"UK-developed communication app suite for speech, language and communication needs including Grid Player.", url:"https://www.therapybox.co.uk", free:false, lastReviewed:"Apr 2026" },
  ...
  { name:"NoRedInk", category:"Writing", subcategory:"Grammar", audience:["Students","Teachers"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI grammar and writing practice that adapts to each student's interests and level.", url:"https://www.noredink.com", free:true, lastReviewed:"Apr 2026" },
  { name:"Turnitin Draft Coach", category:"Writing", subcategory:"Academic Writing", audience:["Students","Teachers"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"Real-time citation and similarity checking integrated into Google Docs for academic writing support.", url:"https://www.turnitin.com", free:false, lastReviewed:"Apr 2026" },
  ...
  { name:"Piktochart", category:"Creative", subcategory:"Infographics", audience:["Teachers","Students","Admin"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI infographic and report creator for visualising data and producing school displays.", url:"https://piktochart.com", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Edulastic", category:"Assessment", subcategory:"Standards Assessment", audience:["Teachers","Admin"], ukReady:"Partial", safety:8, tier:"Trusted", desc:"AI formative and summative assessment with question banks and auto-scoring analytics.", url:"https://edulastic.com", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Ziplet", category:"Assessment", subcategory:"Exit Tickets", audience:["Teachers"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI digital exit ticket tool for quick formative assessment checks at the end of any lesson.", url:"https://ziplet.com", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"ResearchRabbit", category:"Research", subcategory:"Paper Discovery", audience:["Teachers","Students"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI paper discovery tool that surfaces relevant research and maps citation networks.", url:"https://www.researchrabbit.ai", free:true, lastReviewed:"Apr 2026" },
  { name:"Semantic Scholar", category:"Research", subcategory:"AI Literature Search", audience:["Teachers","Students"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Free AI academic search engine with TLDR summaries, citation networks and paper recommendations.", url:"https://www.semanticscholar.org", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Asana", category:"Productivity", subcategory:"Project Management", audience:["Admin","SLT","Teachers"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI project management for school improvement planning, CPD coordination and team tasks.", url:"https://asana.com", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Coda AI", category:"Productivity", subcategory:"Collaborative Docs", audience:["Admin","SLT","Teachers"], ukReady:"Yes", safety:7, tier:"Guided", desc:"AI doc and database tool for building school handbooks, tracking systems and planning documents.", url:"https://coda.io", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Headspace for Education", category:"Wellbeing", subcategory:"Mindfulness", audience:["Students","Teachers"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"Mindfulness and meditation app with a dedicated free education programme for schools and staff.", url:"https://www.headspace.com", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Securus Software", category:"Safeguarding", subcategory:"Online Monitoring", audience:["Admin","SLT"], ukReady:"Yes", safety:9, tier:"Trusted", desc:"AI monitoring that alerts DSLs to at-risk student online behaviour and keyword activity.", url:"https://www.securussoftware.co.uk", free:false, lastReviewed:"Apr 2026" },
  ...
  { name:"NAACE AI in Education", category:"AI Policy", subcategory:"UK Framework", audience:["SLT","Teachers"], ukReady:"Yes", safety:10, tier:"Trusted", desc:"NAACE's framework and guidance for school leaders implementing responsible AI across the curriculum.", url:"https://www.naace.co.uk", free:true, lastReviewed:"Apr 2026" },
  ...
  { name:"Lexia PowerUp", category:"Literacy", subcategory:"Secondary Literacy", audience:["Students","Schools"], ukReady:"Yes", safety:8, tier:"Trusted", desc:"AI-driven literacy programme for secondary students who are behind age-expected reading levels.", url:"https://www.lexialearning.com", free:false, lastReviewed:"Apr 2026" },
